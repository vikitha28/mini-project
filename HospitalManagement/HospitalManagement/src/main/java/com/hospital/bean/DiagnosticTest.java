...
public class DiagnosticTest {
	...
	private List<DiagnosticCenter> availableInCenters;
	...
	public List<DiagnosticCenter> getAvailableInCenters() {
		return availableInCenters;
	}
	public void setAvailableInCenters(List<DiagnosticCenter> availableInCenters) {
	...
	public DiagnosticTest(int id, String testName, double testPrice, String normalValue, String unit,
			List<DiagnosticCenter> availableInCenters) {
		super();
		this.id = id;
		this.testName = testName;
		this.testPrice = testPrice;
